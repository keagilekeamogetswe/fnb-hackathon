export function Nav() {
  return (
    ...
    /* Note: backdrop-filter has minimal browser support */
    <nav className="top-0 right-0 left-[15%] p-10 bottom-0 bg-[#57575766] backdrop-blur-[10px] backdrop-brightness-30 outline outline-[rgba(255,255,255,0.4)] fixed z-50 flex flex-col">
      ...
      <div className="mt-10 flex flex-col gap-y-10 justify-between grow">
        ...
        <div className="-mx-10 -mb-10 p-7 bg-[rgba(84,84,87,0.4)] outline outline-[rgba(255,255,255,0.4)] shadow-[0_4px_8px_rgba(0,0,0,0.25)]" >
          <ul className="flex flex-row gap-x-10 justify-center">
            <li className=" px-4 py-1.5 bg-[#72853F] text-center text-bold rounded-xl">Sign up</li>
            <li className=" px-4 py-1.5 bg-[#A81A26] text-center text-bold  rounded-xl">Report</li>
          </ul>
        </div>
